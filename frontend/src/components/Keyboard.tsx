...
export const Keyboard = ({ usedKeys, onKey }: KeyboardProps) => {
  return (
    <div className="mt-8 px-2 w-full max-w-[500px] mx-auto select-none">
      {ROWS.map((row, i) => (
        <div key={i} className="keyboard-row">
          {// Add spacer for second row to match Wordle layout
          ...
          {row.map((key) => {
            ...
            return (
              ...
              >
                {key === 'BACKSPACE' ? (
                  <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" className="w-[20px] h-[20px]">
